# Test Nylas v3 API with correct endpoints
# Tests calendar events and availability using proper v3 endpoints
...
Write-Host ""
Write-Host "Testing Nylas v3 API..." -ForegroundColor Cyan
...
# Test 2: Check availability (v3 endpoint)
...
Write-Host ""
Write-Host "v3 API test complete!" -ForegroundColor Cyan
