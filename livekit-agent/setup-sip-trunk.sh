...
echo "   https://barbara-livekit-api.fly.dev/api/swml-inbound?to={to}&from={from}"
echo ""
echo "2. For outbound calls via SWML, use:"
echo "   https://barbara-livekit-api.fly.dev/api/swml-outbound?room={room_name}&lead_id={lead_id}"
echo ""
